...
public class BayouBluesBlocks {
    ...
    public static final Block CYPRESS_WOOD = createBlock("cypress_wood", new WoodBlock(STRIPPED_CYPRESS_WOOD, FabricBlockSettings.copy(Blocks.OAK_WOOD)), ItemGroup.BUILDING_BLOCKS);
    public static final Block CYPRESS_LEAVES = createBlock("cypress_leaves", new AbnormalsLeavesBlock(AbstractBlock.Settings.of(Material.LEAVES).strength(0.2F).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning((BlockState state, BlockView reader, BlockPos pos, EntityType<?> entity)->(entity == EntityType.OCELOT || entity == EntityType.PARROT)).suffocates((BlockState state, BlockView reader, BlockPos pos)->false).blockVision((BlockState state, BlockView reader, BlockPos pos)->false)), ItemGroup.DECORATIONS);
    public static final Block CYPRESS_SAPLING = createBlock("cypress_sapling", new AbnormalsSaplingBlock(new CypressTree(), FabricBlockSettings.copy(Blocks.OAK_SAPLING)), ItemGroup.DECORATIONS);
    ...
    public static final Block CYPRESS_PLANKS = createBlock("cypress_planks", new PlanksBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS)), ItemGroup.BUILDING_BLOCKS);
    public static final Block CYPRESS_SLAB = createBlock("cypress_slab", new WoodSlabBlock(FabricBlockSettings.copy(Blocks.OAK_SLAB)), ItemGroup.BUILDING_BLOCKS);
    public static final Block CYPRESS_STAIRS = createBlock("cypress_stairs", new WoodStairsBlock(CYPRESS_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.OAK_STAIRS)), ItemGroup.BUILDING_BLOCKS);
    public static final Block CYPRESS_PRESSURE_PLATE = createBlock("cypress_pressure_plate", new WoodPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE)), ItemGroup.REDSTONE);
    public static final Block CYPRESS_FENCE = createFuelBlock("cypress_fence", new WoodFenceBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE)), 300, ItemGroup.DECORATIONS);
    public static final Block CYPRESS_FENCE_GATE = createFuelBlock("cypress_fence_gate", new WoodFenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE)), 300, ItemGroup.REDSTONE);
    public static final Block CYPRESS_BUTTON = createBlock("cypress_button", new AbnormalsWoodButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON)), ItemGroup.REDSTONE);
    public static final Block CYPRESS_DOOR = createBlock("cypress_door", new WoodDoorBlock(FabricBlockSettings.copy(Blocks.OAK_DOOR)), ItemGroup.REDSTONE);
    public static final Block CYPRESS_TRAPDOOR = createBlock("cypress_trapdoor", new WoodTrapDoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR)), ItemGroup.REDSTONE);
    public static final Pair<RegistryObject<AbnormalsStandingSignBlock>, RegistryObject<AbnormalsWallSignBlock>> CYPRESS_SIGNS = createSignBlock("cypress", MaterialColor.PURPLE_TERRACOTTA);
